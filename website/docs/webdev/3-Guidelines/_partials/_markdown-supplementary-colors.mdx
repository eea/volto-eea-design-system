...
<div className="row">
    ...
    <div className="col col--7">
        <div style={{float:'right'}}> ΕΕΑ main background colour is white but the secondary colours can also be used as background to 
...
<div style={{width:'100%',float:'left'}}>
   ...
   <table style={{float:'left'}}>
        <tbody>
            <tr>
            <td style={{backgroundColor:'#87A7C3'}} className="small-color-box-td-70">
                    <div style={{color:'black'}} className="small-color-box-70">#87A7C3</div>
                </td>            
            </tr>
        </tbody>
    </table>  
