...
<div style={{ width:'100%', float:'left', marginBottom: '40px'}}>
   ...
   <table style={{float:'left'}} >
        <tbody>
            <tr>
            <td style={{backgroundColor:'#A0E5DC'}} className="small-color-box-td-70">
                    <div style={{color:'#3D5265'}} className="small-color-box-70">#A0E5DC</div>
                </td>            
            </tr>
        </tbody>
    </table>
   <table style={{float:'left'}} >
        <tbody>
            <tr>
            <td style={{backgroundColor:'#78CAC0'}} className="small-color-box-td-70">
                    <div style={{color:'#3D5265'}} className="small-color-box-70">#78CAC0</div>
                </td>            
            </tr>
        </tbody>
    </table>  
    ...
    <tbody>
        <tr>
            <td style={{backgroundColor:'#3D5265'}} className="large-color-box-td">
                ...
                <td style={{backgroundColor:'#FFFFFF'}} className="large-color-box-td">
                <div style={{color:'#3D5265'}} className="large-color-box">#FFFFFF <br/>Background colour</div>
            </td>
            <td style={{backgroundColor:'#0083E0'}} className="large-color-box-td">
