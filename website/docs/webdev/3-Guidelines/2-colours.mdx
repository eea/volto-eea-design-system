...
<div style={{ width: '100%', float: 'left', marginBottom: '40px'}}>
  <table style={{float:'left'}}>
    ...
    <table style={{float:'left'}}>
        <tbody>
            ...
            <td style={{backgroundColor:'#008FF5'}} className="small-color-box-td-70">
                    <div style={{color:'black'}} className="small-color-box-70">#008FF5</div>
                </td>            
            </tr>
        </tbody>
    </table>   
   <table style={{float:'left'}}>
        <tbody>
            <tr>
            <td style={{backgroundColor:'#0079CF'}} className="small-color-box-td-70">
                    <div style={{color:'white'}} className="small-color-box-70">#0079CF</div>
                </td>            
            </tr>
        </tbody> </table>
    <table style={{float:'left'}}>
...
![](../md_components/static/wise-f.svg)
...
<div style={{width:'100%',float:'left'}}>
    <table style={{float:'left'}} >
        <tbody>
            <tr>
                <td style={{backgroundColor:'#0079CF'}} className="large-color-box-td">
                    <div style={{color:'white'}} className="large-color-box">#0079CF </div>
                </td>            
            </tr>
        </tbody>
    </table>
...
<table style={{ width:"100%", float:'left', marginBottom: '20px'}} >
    <tbody>
        <tr>
            ...
            <td style={{backgroundColor:'#0079CF'}} className="large-color-box-td">
                <div style={{color:'white'}} className="large-color-box">#0079CF<br/> Elements  </div>
            </td>     
            <td style={{backgroundColor:'#004B7F'}} className="large-color-box-td">
...
![](../md_components/static/wise-m.svg)
